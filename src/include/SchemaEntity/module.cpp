...
//-----------------------------------------------------------------------------
CModule::CModule( const std::string_view szModuleName, bool bSkipMetaModServerModule ) : m_pModuleHandle(nullptr)
{
	InitFromName(szModuleName, bSkipMetaModServerModule );
}
