...
public:
	...
	explicit CModule( const std::string_view svModuleName, bool bSkipMetaModServerModule = false );
	...
	bool InitFromName(const std::string_view svModuleName, bool bSkipMetaModServerModulebool, bool bExtension = false);
	...
	[[nodiscard]] CMemory FindBytesPattern( const char* svPattern ) const;
